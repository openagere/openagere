...
//! orchestration and rollout scanning live in `agere-core`.
...
pub const SQLITE_HOME_ENV: &str = "AGERE_SQLITE_HOME";
...
pub const DB_ERROR_METRIC: &str = "agere.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: &str = "agere.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: &str = "agere.db.backfill.duration_ms";
