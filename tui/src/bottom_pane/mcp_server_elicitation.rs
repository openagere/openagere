...
use agere_app_server_protocol::McpElicitationEnumSchema;
use agere_app_server_protocol::McpElicitationPrimitiveSchema;
use agere_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use agere_protocol::approvals::ElicitationRequest;
...
const APPROVAL_META_KIND_KEY: &str = "agere_approval_kind";
    ...
    fn tool_suggestion_meta_is_parsed_into_request_payload() {
        let request = McpServerElicitationFormRequest::from_event(
            ...
            form_request(
                ...
                empty_object_schema(),
                Some(serde_json::json!({
                    "agere_approval_kind": "tool_suggestion",
                    "tool_type": "connector",
    ...
    fn plugin_tool_suggestion_meta_without_install_url_is_parsed_into_request_payload() {
        let request = McpServerElicitationFormRequest::from_event(
            ...
            form_request(
                ...
                Some(serde_json::json!({
                    ...
                    "tool_id": "slack@openagere-curated",
                    "tool_name": "Slack",
                })),
            ),
        )
        ...
        assert_eq!(
            ...
            Some(&ToolSuggestionRequest {
                ...
                tool_id: "slack@openagere-curated".to_string(),
