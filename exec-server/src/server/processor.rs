    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            JsonRpcConnectionEvent::MalformedMessage { reason } => {
                ...
                if outgoing_tx
                    .send(RpcServerOutboundMessage::Error {
                        request_id: agere_app_server_protocol::RequestId::Integer(-1),
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                agere_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                agere_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                agere_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                agere_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
