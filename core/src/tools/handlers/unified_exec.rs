...
use agere_otel::TOOL_CALL_UNIFIED_EXEC_METRIC;
    ...
    async fn handle(&self, invocation: ToolInvocation) -> Result<Self::Output, FunctionCallError> {
        ...
        let response = match tool_name.name.as_str() {
            "exec_command" => {
                ...
                let command_for_display = agere_shell_command::parse_command::shlex_join(&command);
                    ...
                    .await
                {
                    ...
                    Err(UnifiedExecError::PolicyDenied { output, .. }) => {
                        ...
                        ExecCommandToolOutput {
                            ...
                            max_output_tokens: Some(max_output_tokens),
                            // Policy denial is terminal, so there is no live
