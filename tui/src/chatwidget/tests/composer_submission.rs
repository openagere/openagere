...
async fn submission_includes_configured_permission_profile() {
    ...
    let expected_permission_profile = PermissionProfile::Managed {
        ...
        file_system: agere_protocol::models::ManagedFileSystemPermissions::Restricted {
            entries: vec![
                agere_protocol::permissions::FileSystemAccessEntry {
                    path: agere_protocol::permissions::FileSystemPath::Special {
                        value: agere_protocol::permissions::FileSystemSpecialPath::Root,
                    },
                    access: agere_protocol::permissions::FileSystemAccessMode::Read,
                },
                agere_protocol::permissions::FileSystemAccessEntry {
...
#[tokio::test]
async fn normal_submission_omits_reasoning_summary_override() {
    let (mut chat, mut rx, mut op_rx) = make_chatwidget_manual(/*model_override*/ None).await;
