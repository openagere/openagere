...
use agere_protocol::protocol::GuardianAssessmentOutcome;
use agere_protocol::protocol::GuardianCommandSource;
use agere_protocol::protocol::GuardianRiskLevel;
use agere_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(AgereAppMentionedEventRequest),
    AppUsed(AgereAppUsedEventRequest),
    HookRun(AgereHookRunEventRequest),
    Compaction(Box<AgereCompactionEventRequest>),
    TurnEvent(Box<AgereTurnEventRequest>),
    TurnSteer(AgereTurnSteerEventRequest),
    PluginUsed(AgerePluginUsedEventRequest),
    PluginInstalled(AgerePluginEventRequest),
    PluginUninstalled(AgerePluginEventRequest),
    PluginEnabled(AgerePluginEventRequest),
    PluginDisabled(AgerePluginEventRequest),
}
...
pub(crate) struct AgereAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct AgereRuntimeMetadata {
    pub(crate) agere_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: AgereAppServerClientMetadata,
    pub(crate) runtime: AgereRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main Agere turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct AgereAppMetadata {
...
#[derive(Serialize)]
pub(crate) struct AgereAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgereAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgereAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgereAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgereHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct AgereHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgereHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgereCompactionEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AgereCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgereCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct AgereTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<AgereErrorInfo>,
...
#[derive(Serialize)]
pub(crate) struct AgereTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgereTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct AgereTurnSteerEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct AgereTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgereTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct AgerePluginMetadata {
...
#[derive(Serialize)]
pub(crate) struct AgerePluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: AgerePluginMetadata,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
}
...
#[derive(Serialize)]
pub(crate) struct AgerePluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgerePluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct AgerePluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: AgerePluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "agere_plugin_installed",
        PluginState::Uninstalled => "agere_plugin_uninstalled",
        PluginState::Enabled => "agere_plugin_enabled",
        PluginState::Disabled => "agere_plugin_disabled",
    }
}

pub(crate) fn agere_app_metadata(
...
pub(crate) fn agere_plugin_metadata(plugin: PluginTelemetryMetadata) -> AgerePluginMetadata {
...
pub(crate) fn agere_compaction_event_params(
    input: AgereCompactionEvent,
    app_server_client: AgereAppServerClientMetadata,
    runtime: AgereRuntimeMetadata,
    thread_source: Option<&'static str>,
    subagent_source: Option<String>,
    parent_thread_id: Option<String>,
) -> AgereCompactionEventParams {
    AgereCompactionEventParams {
...
pub(crate) fn agere_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> AgerePluginUsedMetadata {
    AgerePluginUsedMetadata {
        plugin: agere_plugin_metadata(plugin),
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
    }
...
pub(crate) fn agere_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> AgereHookRunMetadata {
    AgereHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
...
pub(crate) fn current_runtime_metadata() -> AgereRuntimeMetadata {
    let os_info = os_info::get();
    AgereRuntimeMetadata {
        agere_rs_version: env!("CARGO_PKG_VERSION").to_string(),
