//! Rollout persistence and discovery for Agere session files.
...
pub(crate) mod default_client {
    pub use agere_login::default_client::*;
}

pub(crate) use agere_protocol::protocol;
...
pub use agere_protocol::protocol::SessionMeta;
