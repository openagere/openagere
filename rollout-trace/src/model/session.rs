...
/// One Agere thread/session participating in the rollout.
///
...
/// Provenance for a traced Agere thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the Agere runtime for one thread.
///
/// A Agere turn groups protocol/runtime work for one thread activation.
/// It is not a user/assistant message pair; conversation belongs in
/// `ConversationItem`.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct AgereTurn {
