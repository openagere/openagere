        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    agere_turn_id: event.agere_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(agere_turn_id) = event.agere_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a agere turn id"
                    );
                };
