...
//! "leave the old title alone" or "clear the title Agere last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Agere manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Agere started managing the title.
