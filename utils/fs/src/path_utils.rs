//! Path normalization, symlink resolution, and atomic writes shared across Agere crates.

pub use crate::env::is_wsl;
...
fn normalize_for_wsl(path: PathBuf) -> PathBuf {
    normalize_for_wsl_with_flag(path, crate::env::is_wsl())
}
