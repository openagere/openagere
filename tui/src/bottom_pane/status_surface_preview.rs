...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "agere",
            ...
            StatusSurfacePreviewItem::AgereVersion => "0.0.1",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.4",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.4 medium",
