//! Shared model metadata types exchanged between Agere services and clients.
//!
...
impl ReasoningEffort {
    pub fn supported_in_responses(&self) -> bool {
        matches!(
            self,
    ...
    pub fn supported_in_anthropic(&self) -> bool {
        matches!(
            self,
    ...
    pub fn supported_in_chat(&self) -> bool {
        matches!(self, Self::Minimal | Self::Low | Self::Medium | Self::High)
    }

    /// Human-readable description for this reasoning effort level.
    pub fn description(&self) -> &'static str {
        match self {
            Self::None => "no reasoning",
...
/// Metadata describing a Agere-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Agere backend `/models` endpoint.
