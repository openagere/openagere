use crate::agere_message_processor::ApiVersion;
use crate::agere_message_processor::read_rollout_items_from_rollout;
use crate::agere_message_processor::read_summary_from_rollout;
use crate::agere_message_processor::summary_to_thread;
...
use agere_app_server_protocol::AccountRateLimitsUpdatedNotification;
use agere_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use agere_app_server_protocol::AgentMessageDeltaNotification;
use agere_app_server_protocol::AgereErrorInfo as V2AgereErrorInfo;
use agere_app_server_protocol::ApplyPatchApprovalParams;
use agere_app_server_protocol::ApplyPatchApprovalResponse;
use agere_app_server_protocol::CollabAgentState as V2CollabAgentStatus;
use agere_app_server_protocol::CollabAgentTool;
use agere_app_server_protocol::CollabAgentToolCallStatus as V2CollabToolCallStatus;
use agere_app_server_protocol::CommandAction as V2ParsedCommand;
use agere_app_server_protocol::CommandExecutionApprovalDecision;
use agere_app_server_protocol::CommandExecutionOutputDeltaNotification;
use agere_app_server_protocol::CommandExecutionRequestApprovalParams;
use agere_app_server_protocol::CommandExecutionRequestApprovalResponse;
use agere_app_server_protocol::CommandExecutionSource;
use agere_app_server_protocol::CommandExecutionStatus;
use agere_app_server_protocol::ContextCompactedNotification;
use agere_app_server_protocol::DeprecationNoticeNotification;
use agere_app_server_protocol::DynamicToolCallOutputContentItem;
use agere_app_server_protocol::DynamicToolCallParams;
use agere_app_server_protocol::DynamicToolCallStatus;
use agere_app_server_protocol::ErrorNotification;
use agere_app_server_protocol::ExecCommandApprovalParams;
use agere_app_server_protocol::ExecCommandApprovalResponse;
use agere_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use agere_app_server_protocol::FileChangeApprovalDecision;
use agere_app_server_protocol::FileChangeOutputDeltaNotification;
use agere_app_server_protocol::FileChangePatchUpdatedNotification;
use agere_app_server_protocol::FileChangeRequestApprovalParams;
use agere_app_server_protocol::FileChangeRequestApprovalResponse;
use agere_app_server_protocol::FileUpdateChange;
use agere_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use agere_app_server_protocol::GuardianWarningNotification;
use agere_app_server_protocol::HookCompletedNotification;
use agere_app_server_protocol::HookStartedNotification;
use agere_app_server_protocol::InterruptConversationResponse;
use agere_app_server_protocol::ItemCompletedNotification;
use agere_app_server_protocol::ItemStartedNotification;
use agere_app_server_protocol::McpServerElicitationAction;
use agere_app_server_protocol::McpServerElicitationRequestParams;
use agere_app_server_protocol::McpServerElicitationRequestResponse;
use agere_app_server_protocol::McpServerStartupState;
use agere_app_server_protocol::McpServerStatusUpdatedNotification;
use agere_app_server_protocol::McpToolCallError;
use agere_app_server_protocol::McpToolCallResult;
use agere_app_server_protocol::McpToolCallStatus;
use agere_app_server_protocol::ModelReroutedNotification;
use agere_app_server_protocol::ModelVerificationNotification;
use agere_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use agere_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use agere_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use agere_app_server_protocol::PatchApplyStatus;
use agere_app_server_protocol::PermissionsRequestApprovalParams;
use agere_app_server_protocol::PermissionsRequestApprovalResponse;
use agere_app_server_protocol::PlanDeltaNotification;
use agere_app_server_protocol::RawResponseItemCompletedNotification;
use agere_app_server_protocol::ReasoningSummaryPartAddedNotification;
use agere_app_server_protocol::ReasoningSummaryTextDeltaNotification;
use agere_app_server_protocol::ReasoningTextDeltaNotification;
...
use agere_app_server_protocol::TerminalInteractionNotification;
...
use agere_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use agere_app_server_protocol::ThreadRealtimeSdpNotification;
use agere_app_server_protocol::ThreadRealtimeStartedNotification;
use agere_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use agere_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use agere_app_server_protocol::ThreadRollbackResponse;
use agere_app_server_protocol::ThreadTokenUsage;
use agere_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use agere_app_server_protocol::ToolRequestUserInputOption;
use agere_app_server_protocol::ToolRequestUserInputParams;
use agere_app_server_protocol::ToolRequestUserInputQuestion;
use agere_app_server_protocol::ToolRequestUserInputResponse;
use agere_app_server_protocol::Turn;
use agere_app_server_protocol::TurnCompletedNotification;
use agere_app_server_protocol::TurnDiffUpdatedNotification;
use agere_app_server_protocol::TurnError;
use agere_app_server_protocol::TurnInterruptResponse;
use agere_app_server_protocol::TurnPlanStep;
use agere_app_server_protocol::TurnPlanUpdatedNotification;
use agere_app_server_protocol::TurnStartedNotification;
use agere_app_server_protocol::TurnStatus;
use agere_app_server_protocol::WarningNotification;
use agere_app_server_protocol::build_command_execution_end_item;
use agere_app_server_protocol::build_file_change_approval_request_item;
use agere_app_server_protocol::build_file_change_begin_item;
use agere_app_server_protocol::build_file_change_end_item;
use agere_app_server_protocol::build_item_from_guardian_event;
use agere_app_server_protocol::build_turns_from_rollout_items;
use agere_app_server_protocol::convert_patch_changes;
use agere_app_server_protocol::guardian_auto_approval_review_notification;
use agere_core::AgereThread;
use agere_core::ThreadManager;
use agere_core::find_thread_name_by_id;
use agere_core::review_format::format_review_findings_block;
use agere_core::review_prompts;
use agere_protocol::ThreadId;
use agere_protocol::dynamic_tools::DynamicToolCallOutputContentItem as CoreDynamicToolCallOutputContentItem;
use agere_protocol::dynamic_tools::DynamicToolResponse as CoreDynamicToolResponse;
use agere_protocol::items::parse_hook_prompt_message;
...
use agere_protocol::protocol::RealtimeEvent;
...
use agere_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use agere_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use agere_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use agere_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            if let ApiVersion::V2 = api_version {
                let (status, error) = match update.status {
                    agere_protocol::protocol::McpStartupStatus::Starting => {
                        (McpServerStartupState::Starting, None)
                    }
                    agere_protocol::protocol::McpStartupStatus::Ready => {
                        (McpServerStartupState::Ready, None)
                    }
                    agere_protocol::protocol::McpStartupStatus::Failed { error } => {
                        (McpServerStartupState::Failed, Some(error))
                    }
                    agere_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            if let ApiVersion::V2 = api_version {
                ...
                if assessment.status
                    == agere_protocol::protocol::GuardianAssessmentStatus::InProgress
                ...
                let completion_status = match assessment.status {
                    agere_protocol::protocol::GuardianAssessmentStatus::Denied
                    | agere_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                        Some(CommandExecutionStatus::Declined)
                    }
                    agere_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                        Some(CommandExecutionStatus::Failed)
                    }
                    agere_protocol::protocol::GuardianAssessmentStatus::InProgress
                    | agere_protocol::protocol::GuardianAssessmentStatus::Approved => None,
                };
                    ...
                    Err(err) => {
                        ...
                        if let Err(err) = conversation
                            .submit(Op::ResolveElicitation {
                                ...
                                request_id: request.id,
                                decision: agere_protocol::approvals::ElicitationAction::Cancel,
                                content: None,
                                meta: None,
                            })
                            .await
        ...
        EventMsg::CollabAgentSpawnEnd(end_event) => {
            ...
            let status = match &end_event.status {
                agere_protocol::protocol::AgentStatus::Errored(_)
                | agere_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        ...
        EventMsg::CollabWaitingEnd(end_event) => {
            let status = if end_event.statuses.values().any(|status| {
                matches!(
                    status,
                    agere_protocol::protocol::AgentStatus::Errored(_)
                        | agere_protocol::protocol::AgentStatus::NotFound
                )
            }) {
        ...
        EventMsg::AgentMessageContentDelta(event) => {
            let agere_protocol::protocol::AgentMessageContentDeltaEvent { item_id, delta, .. } =
                event;
        ...
        EventMsg::Error(ev) => {
            ...
            let agere_error_info = ev.agere_error_info.clone();
            ...
            if matches!(
                agere_error_info,
                Some(CoreAgereErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                agere_error_info: ev.agere_error_info.map(V2AgereErrorInfo::from),
        ...
        EventMsg::ItemCompleted(item_completed_event) => {
            ...
            let notification = ItemCompletedNotification {
                ...
                turn_id: event_turn_id.clone(),
                item,
                is_interim: item_completed_event.is_interim,
            };
            outgoing
                .send_server_notification(ServerNotification::ItemCompleted(notification))
                .await;
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(api_version, ApiVersion::V2)
                && matches!(
                    ...
                    agere_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
                )
            {
                        ...
                        match read_rollout_items_from_rollout(rollout_path.as_path()).await {
                            Ok(items) => {
                                ...
                                thread.status = thread_watch_manager
                                    ...
                                    .await;
                                match find_thread_name_by_id(agere_home, &conversation_id).await {
                                    Ok(name) => {
                                        thread.name = name;
                                    }
                                    Err(err) => {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let agere_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(agere_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
        is_interim: false,
    };
...
async fn respond_to_pending_interrupts(
    thread_state: &Arc<Mutex<ThreadState>>,
    outgoing: &ThreadScopedOutgoingMessageSender,
    abort_reason: Option<agere_protocol::protocol::TurnAbortReason>,
) {
    let pending = {
        let mut state = thread_state.lock().await;
...
async fn on_exec_approval_response(
    ...
    // Try to deserialize `value` and then make the appropriate call to `agere`.
    let response =
...
fn request_permissions_response_from_client_result(
    _requested_permissions: CoreRequestPermissionProfile,
    response: std::result::Result<ClientRequestResult, oneshot::error::RecvError>,
    _cwd: &std::path::Path,
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: agere_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            agere_app_server_protocol::PermissionGrantScope::Session
        )
    {
    ...
    let permissions = granted_permissions.into();
...
fn collab_resume_begin_item(
    begin_event: agere_protocol::protocol::CollabResumeBeginEvent,
) -> ThreadItem {
...
fn collab_resume_end_item(end_event: agere_protocol::protocol::CollabResumeEndEvent) -> ThreadItem {
    let status = match &end_event.status {
        agere_protocol::protocol::AgentStatus::Errored(_)
        | agere_protocol::protocol::AgentStatus::NotFound => V2CollabToolCallStatus::Failed,
        _ => V2CollabToolCallStatus::Completed,
...
mod tests {
    ...
    use agere_app_server_protocol::AutoReviewDecisionSource;
    use agere_app_server_protocol::GuardianApprovalReviewStatus;
    ...
    use agere_protocol::items::HookPromptFragment;
    use agere_protocol::items::build_hook_prompt_message;
    ...
    use agere_protocol::plan_tool::PlanItemArg;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: agere_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(agere_protocol::protocol::GuardianRiskLevel::Low),
                Some(agere_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(agere_protocol::protocol::GuardianRiskLevel::High),
                Some(agere_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(agere_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = agere_protocol::protocol::GuardianAssessmentAction::Command {
            source: agere_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                turn_id: String::new(),
                status: agere_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: agere_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(agere_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(agere_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    agere_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(agere_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(agere_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = agere_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: agere_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                target_item_id: None,
                turn_id: "turn-from-assessment".to_string(),
                status: agere_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    fn collab_resume_end_maps_to_item_completed_resume_agent() {
        let event = CollabResumeEndEvent {
            ...
            receiver_agent_nickname: None,
            receiver_agent_role: None,
            status: agere_protocol::protocol::AgentStatus::NotFound,
        };
        ...
        let expected = ThreadItem::CollabAgentToolCall {
            ...
            agents_states: [(
                receiver_id,
                V2CollabAgentStatus::from(agere_protocol::protocol::AgentStatus::NotFound),
            )]
            .into_iter()
            .collect(),
        };
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agere_error_info: Some(V2AgereErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agere_error_info: Some(V2AgereErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("agere"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                agere_error_info: Some(V2AgereErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            agere_app_server_protocol::HookPromptFragment {
