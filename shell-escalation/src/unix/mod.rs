...
//! `EscalateRequest` over the inherited `AGERE_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `AGERE_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use agere_protocol::approvals::EscalationPermissions;
pub use agere_protocol::approvals::ResolvedPermissionProfile;
