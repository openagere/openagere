use crate::default_client::AgereHttpClient;
use crate::default_client::AgereRequestBuilder;
...
pub struct ReqwestTransport {
    client: AgereHttpClient,
}

impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: AgereHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<AgereRequestBuilder, TransportError> {
