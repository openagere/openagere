...
/// Runtime operation requested by the model, a JS code cell, or Agere itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_agere_turn_id: Option<AgereTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the Agere tool boundary.
    ///
    ...
    /// they describe how Agere executed the request, not what the caller sent.
