...
pub(crate) enum AppCommandView<'a> {
    ...
    UserTurn {
        ...
        summary: &'a Option<Option<ReasoningSummaryConfig>>,
    ...
    OverrideTurnContext {
        ...
        windows_execution_restriction_level: &'a Option<WindowsExecutionRestrictionLevel>,
...
impl AppCommand {
    ...
    pub(crate) fn user_turn(
        ...
        let _access_policy = legacy_profile
