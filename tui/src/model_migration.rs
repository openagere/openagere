...
pub(crate) fn migration_copy_for_models(
    ...
    let heading_text = Span::from(format!(
        "Agere just got an upgrade. Introducing {target_display_name}."
    ))
    .bold();
...
impl ModelMigrationScreen {
    ...
    fn render_menu(&self, column: &mut ColumnRenderable) {
        column.push(Line::from(""));
        column.push(
            Paragraph::new("Choose how you'd like Agere to proceed.")
                .wrap(Wrap { trim: false })
                .inset(Insets::tlbr(
                    /*top*/ 0, /*left*/ 2, /*bottom*/ 0, /*right*/ 0,
                )),
    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                "gpt-5.4",
                /*model_link*/ None,
                Some("Upgrade to gpt-5.4 for the latest and greatest coding model.".to_string()),
    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.agere.com/models/gpt-5.1".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "gpt-5.1".to_string(),
    ...
    fn prompt_snapshot_gpt54() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5.3",
                "gpt-5.4",
                Some("https://openai.com/index/introducing-gpt-5-4".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "gpt-5.4".to_string(),
                Some(
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt54", terminal.backend());
    }

    #[test]
    fn prompt_snapshot_gpt54_mini() {
        let backend = VT100Backend::new(/*width*/ 60, /*height*/ 22);
        let mut terminal = Terminal::with_options(backend).expect("terminal");
        terminal.set_viewport_area(Rect::new(0, 0, 60, 22));
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                Some("Smaller model for faster, lower-cost everyday coding tasks.".to_string()),
                /*can_opt_out*/ false,
            ),
        );
        {
        ...
        terminal.flush().expect("flush");
        assert_snapshot!("model_migration_prompt_gpt54_mini", terminal.backend());
    }
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.agere.com/models/gpt-new".to_string()),
                /*migration_copy*/ None,
                /*migration_markdown*/ None,
                "gpt-new".to_string(),
