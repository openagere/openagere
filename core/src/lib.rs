//! Root of the `agere-core` library.
...
pub use agere_thread::AgereThreadTurnContextOverrides;
pub use agere_thread::ThreadConfigSnapshot;
mod agent;
mod agere_delegate;
...
pub(crate) mod access_policy_transforms;
...
#[deprecated(note = "use AgereThread")]
pub type AgereConversation = AgereThread;
...
pub use client::X_AGERE_INSTALLATION_ID_HEADER;
pub use client::X_AGERE_TURN_METADATA_HEADER;
