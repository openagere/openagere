...
use agere_git_utils::get_git_remote_urls_assume_git_repo;
use agere_git_utils::get_git_repo_root;
use agere_git_utils::get_has_changes;
use agere_git_utils::get_head_commit_hash;
...
pub async fn build_turn_metadata_header(
    ...
    build_turn_metadata_bag(
        ...
        /*thread_source*/ None,
        /*turn_id*/ None,
        access_mode.map(ToString::to_string),
        repo_root,
...
impl TurnMetadataState {
    pub(crate) fn new(
        ...
        let repo_root = get_git_repo_root(&cwd).map(|root| root.to_string_lossy().into_owned());
        let access_mode = Some(permission_profile_access_mode_tag(
            permission_profile,
    ...
    pub(crate) fn spawn_git_enrichment_task(&self) {
        ...
        *task_guard = Some(tokio::spawn(async move {
            ...
            let enriched_metadata = build_turn_metadata_bag(
                ...
                state.base_metadata.access_mode.clone(),
                Some(repo_root),
