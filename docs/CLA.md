# Individual Contributor License Agreement (v1.0, OpenAgere)
...
past and future “Contributions” submitted to the **OpenAgere CLI open source
project maintained under the OpenAgere organization (the “Project”)**.
...
You grant **OpenAgere**, its successors and assigns, and all recipients of
...
You grant **OpenAgere**, its successors and assigns, and all recipients of the
Project a perpetual, worldwide, non-exclusive, royalty-free, irrevocable
(except as below) patent license to make, have made, use, sell, offer to sell,
import, and otherwise transfer Your Contributions alone or in combination with
the Project.
