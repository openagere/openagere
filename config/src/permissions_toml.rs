...
use agere_network_proxy::NetworkDomainPermission as ProxyNetworkDomainPermission;
use agere_network_proxy::NetworkMode;
...
pub struct FilesystemPermissionsToml {
    ...
    /// platforms that snapshot glob matches before applying the enforced filesystem profile.
