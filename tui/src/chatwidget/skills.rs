...
use agere_core_skills::model::SkillDependencies;
use agere_core_skills::model::SkillInterface;
use agere_core_skills::model::SkillMetadata;
use agere_core_skills::model::SkillToolDependency;
...
use agere_utils_plugins_placeholder::mention_syntax::TOOL_MENTION_SIGIL;
