...
//! `schemars`) so they can be embedded in Agere's own protocol structures.
...
// === Adapter helpers ===
//
// These types and conversions intentionally live in `agere-protocol` so other crates can convert
