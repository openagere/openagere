...
impl SkillsManager {
    pub fn new(agere_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(agere_home, bundled_skills_enabled, Some(Product::Agere))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.agere_home);
        } else if let Err(err) = install_system_skills(&manager.agere_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &agere_config::ConfigLayerStack,
) -> bool {
