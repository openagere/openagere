...
pub(crate) struct ConfiguredHandler {
    pub event_name: agere_protocol::protocol::HookEventName,
    pub is_managed: bool,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            agere_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            agere_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            agere_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            agere_protocol::protocol::HookEventName::SessionStart => "session-start",
            agere_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
