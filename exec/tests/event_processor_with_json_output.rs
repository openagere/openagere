use agere_app_server_protocol::CollabAgentState as ApiCollabAgentState;
use agere_app_server_protocol::CollabAgentStatus as ApiCollabAgentStatus;
use agere_app_server_protocol::CollabAgentTool;
use agere_app_server_protocol::CollabAgentToolCallStatus as ApiCollabAgentToolCallStatus;
use agere_app_server_protocol::CommandAction;
use agere_app_server_protocol::CommandExecutionSource;
use agere_app_server_protocol::CommandExecutionStatus as ApiCommandExecutionStatus;
use agere_app_server_protocol::ErrorNotification;
use agere_app_server_protocol::FileUpdateChange as ApiFileUpdateChange;
...
use agere_app_server_protocol::McpToolCallStatus as ApiMcpToolCallStatus;
use agere_app_server_protocol::PatchApplyStatus as ApiPatchApplyStatus;
use agere_app_server_protocol::PatchChangeKind as ApiPatchChangeKind;
...
use agere_app_server_protocol::WebSearchAction as ApiWebSearchAction;
...
use agere_exec::AgentMessageItem;
use agere_exec::AgereStatus;
use agere_exec::CollabAgentState;
use agere_exec::CollabAgentStatus;
use agere_exec::CollabTool;
use agere_exec::CollabToolCallItem;
use agere_exec::CollabToolCallStatus;
use agere_exec::CollectedThreadEvents;
use agere_exec::CommandExecutionItem;
use agere_exec::CommandExecutionStatus;
use agere_exec::ErrorItem;
use agere_exec::EventProcessorWithJsonOutput;
use agere_exec::ExecThreadItem;
use agere_exec::FileChangeItem;
use agere_exec::FileUpdateChange as ExecFileUpdateChange;
use agere_exec::ItemCompletedEvent;
use agere_exec::ItemStartedEvent;
use agere_exec::ItemUpdatedEvent;
use agere_exec::McpToolCallItem;
use agere_exec::McpToolCallItemError;
use agere_exec::McpToolCallItemResult;
use agere_exec::McpToolCallStatus;
use agere_exec::PatchApplyStatus;
use agere_exec::PatchChangeKind;
use agere_exec::ReasoningItem;
use agere_exec::ThreadErrorEvent;
use agere_exec::ThreadEvent;
use agere_exec::ThreadItemDetails;
use agere_exec::ThreadStartedEvent;
use agere_exec::TodoItem;
use agere_exec::TodoListItem;
use agere_exec::TurnCompletedEvent;
use agere_exec::TurnFailedEvent;
use agere_exec::TurnStartedEvent;
use agere_exec::Usage;
use agere_exec::WebSearchItem;
...
fn plan_update_emits_started_then_updated_then_completed() {
    ...
    assert_eq!(
        ...
        CollectedThreadEvents {
            ...
            status: AgereStatus::InitiateShutdown,
        }
    );
}
...
fn token_usage_update_is_emitted_on_turn_completion() {
    ...
    let usage_update =
        processor.collect_thread_events(ServerNotification::ThreadTokenUsageUpdated(
            agere_app_server_protocol::ThreadTokenUsageUpdatedNotification {
                thread_id: "thread-1".to_string(),
                turn_id: "turn-1".to_string(),
...
fn failed_turn_clears_stale_final_message() {
    ...
    assert_eq!(collected.status, AgereStatus::Running);
    ...
    assert_eq!(collected.status, AgereStatus::InitiateShutdown);
...
fn model_reroute_surfaces_as_error_item() {
    ...
    let collected = processor.collect_thread_events(ServerNotification::ModelRerouted(
        agere_app_server_protocol::ModelReroutedNotification {
            thread_id: "thread-1".to_string(),
            turn_id: "turn-1".to_string(),
            from_model: "gpt-5".to_string(),
            to_model: "gpt-5-mini".to_string(),
            reason: agere_app_server_protocol::ModelRerouteReason::HighRiskCyberActivity,
        },
    ));
