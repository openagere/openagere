...
use agere_exec_server::ExecServerClient;
use agere_exec_server::RemoteExecServerConnectArgs;
...
fn streamable_http_server_bin() -> Result<PathBuf, CargoBinError> {
    agere_utils_cargo_bin::cargo_bin("test_streamable_http_server")
}
...
fn init_params() -> InitializeRequestParams {
    InitializeRequestParams {
        ...
        client_info: Implementation {
            name: "agere-test".into(),
            version: "0.0.0-test".into(),
            title: Some("Agere rmcp recovery test".into()),
            description: None,
            icons: None,
            website_url: None,
        },
...
pub(crate) async fn spawn_exec_server() -> anyhow::Result<ExecServerProcess> {
    ...
    let mut child = Command::new(agere_utils_cargo_bin::cargo_bin("agere")?)
...
/// Reads the websocket URL printed by `agere exec-server --listen`.
