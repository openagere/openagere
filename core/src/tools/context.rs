...
use agere_utils_common::take_bytes_at_char_boundary;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the Agere tool call id
        ...
        ResponseInputItem::Message { content, .. } => content_items_to_code_mode_result(
            &content
                ...
                .map(|item| match item {
                    ...
                    agere_protocol::models::ContentItem::InputImage { image_url, detail } => {
