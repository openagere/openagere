...
```json
{
  ...
  "interface": {
    ...
    "websiteURL": "https://openagere.com/",
    "privacyPolicyURL": "https://openagere.com/policies/row-privacy-policy/",
    "termsOfServiceURL": "https://openagere.com/policies/row-terms-of-use/",
    "defaultPrompt": [
...
- This repo’s scaffold writes `.openagere-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how Agere renders plugins.
