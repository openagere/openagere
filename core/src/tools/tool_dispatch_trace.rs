...
//!
//! `agere-rollout-trace` owns the event schema and writer behavior. This module
...
use agere_rollout_trace::ToolDispatchInvocation;
use agere_rollout_trace::ToolDispatchPayload;
use agere_rollout_trace::ToolDispatchRequester;
use agere_rollout_trace::ToolDispatchResult;
use agere_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        agere_turn_id: invocation.turn.sub_id.clone(),
