...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("list", "List", "move_left", "Move focus left within a list view."),
    action("list", "List", "move_right", "Move focus right within a list view."),
    action("list", "List", "page_up", "Page the list up."),
    action("list", "List", "page_down", "Page the list down."),
    action("list", "List", "jump_top", "Jump to the top of the list."),
    action("list", "List", "jump_bottom", "Jump to the bottom of the list."),
