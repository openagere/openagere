use agere_utils_cargo_bin::repo_root;
...
// Note: This test requires fixtures in agere-rs/apply-patch/tests/fixtures/scenarios which may not exist.
#[test]
#[ignore]
fn test_apply_patch_scenarios_disabled() -> anyhow::Result<()> {
...
fn run_apply_patch_scenario(dir: &Path) -> anyhow::Result<()> {
    ...
    Command::new(agere_utils_cargo_bin::cargo_bin("apply_patch")?)
        .arg(patch)
