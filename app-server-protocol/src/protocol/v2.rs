...
use agere_experimental_api_macros::ExperimentalApi;
use agere_protocol::account::PlanType;
use agere_protocol::account::ProviderAccount;
use agere_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use agere_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use agere_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use agere_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use agere_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use agere_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use agere_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use agere_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use agere_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use agere_protocol::config_types::AccessMode as CoreAccessMode;
use agere_protocol::config_types::ApprovalsReviewer as CoreApprovalsReviewer;
use agere_protocol::config_types::CollaborationMode;
use agere_protocol::config_types::CollaborationModeMask as CoreCollaborationModeMask;
...
use agere_protocol::config_types::Verbosity;
use agere_protocol::config_types::WebSearchMode;
use agere_protocol::config_types::WebSearchToolConfig;
use agere_protocol::items::AgentMessageContent as CoreAgentMessageContent;
use agere_protocol::items::TurnItem as CoreTurnItem;
use agere_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use agere_protocol::mcp::Resource as McpResource;
pub use agere_protocol::mcp::ResourceContent as McpResourceContent;
use agere_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use agere_protocol::mcp::Tool as McpTool;
use agere_protocol::memory_citation::MemoryCitation as CoreMemoryCitation;
use agere_protocol::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
use agere_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use agere_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
use agere_protocol::models::ManagedFileSystemPermissions as CoreManagedFileSystemPermissions;
use agere_protocol::models::MessagePhase;
use agere_protocol::models::NetworkPermissions as CoreNetworkPermissions;
use agere_protocol::models::PermissionProfile as CorePermissionProfile;
use agere_protocol::models::ResponseItem;
use agere_protocol::openai_models::InputModality;
use agere_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use agere_protocol::openai_models::ReasoningEffort;
use agere_protocol::openai_models::default_input_modalities;
use agere_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use agere_protocol::permissions::FileSystemAccessEntry as CoreFileSystemAccessEntry;
use agere_protocol::permissions::FileSystemAccessMode as CoreFileSystemAccessMode;
use agere_protocol::permissions::FileSystemPath as CoreFileSystemPath;
use agere_protocol::permissions::FileSystemSpecialPath as CoreFileSystemSpecialPath;
use agere_protocol::permissions::NetworkAccessPolicy as CoreNetworkAccessPolicy;
use agere_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use agere_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use agere_protocol::protocol::AgentStatus as CoreAgentStatus;
use agere_protocol::protocol::AgereErrorInfo as CoreAgereErrorInfo;
use agere_protocol::protocol::AskForApproval as CoreAskForApproval;
use agere_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use agere_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use agere_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use agere_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use agere_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use agere_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use agere_protocol::protocol::HookEventName as CoreHookEventName;
use agere_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use agere_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use agere_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use agere_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use agere_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use agere_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use agere_protocol::protocol::HookScope as CoreHookScope;
use agere_protocol::protocol::HookSource as CoreHookSource;
use agere_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use agere_protocol::protocol::ModelVerification as CoreModelVerification;
use agere_protocol::protocol::NonSteerableTurnKind as CoreNonSteerableTurnKind;
use agere_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use agere_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use agere_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use agere_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use agere_protocol::protocol::RealtimeAudioFrame as CoreRealtimeAudioFrame;
use agere_protocol::protocol::RealtimeConversationVersion;
use agere_protocol::protocol::RealtimeOutputModality;
use agere_protocol::protocol::RealtimeVoice;
use agere_protocol::protocol::RealtimeVoicesList;
use agere_protocol::protocol::ReviewDecision as CoreReviewDecision;
use agere_protocol::protocol::SessionSource as CoreSessionSource;
use agere_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use agere_protocol::protocol::SkillInterface as CoreSkillInterface;
use agere_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use agere_protocol::protocol::SkillScope as CoreSkillScope;
use agere_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
use agere_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use agere_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use agere_protocol::protocol::TokenUsage as CoreTokenUsage;
use agere_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
use agere_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use agere_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use agere_protocol::user_input::ByteRange as CoreByteRange;
use agere_protocol::user_input::TextElement as CoreTextElement;
use agere_protocol::user_input::UserInput as CoreUserInput;
...
impl From<CoreAgereErrorInfo> for AgereErrorInfo {
    fn from(value: CoreAgereErrorInfo) -> Self {
        match value {
            CoreAgereErrorInfo::ContextWindowExceeded => AgereErrorInfo::ContextWindowExceeded,
            CoreAgereErrorInfo::UsageLimitExceeded => AgereErrorInfo::UsageLimitExceeded,
            CoreAgereErrorInfo::ServerOverloaded => AgereErrorInfo::ServerOverloaded,
            CoreAgereErrorInfo::CyberPolicy => AgereErrorInfo::CyberPolicy,
            CoreAgereErrorInfo::HttpConnectionFailed { http_status_code } => {
                AgereErrorInfo::HttpConnectionFailed { http_status_code }
            }
            CoreAgereErrorInfo::ResponseStreamConnectionFailed { http_status_code } => {
                AgereErrorInfo::ResponseStreamConnectionFailed { http_status_code }
            }
            CoreAgereErrorInfo::InternalServerError => AgereErrorInfo::InternalServerError,
            CoreAgereErrorInfo::Unauthorized => AgereErrorInfo::Unauthorized,
            CoreAgereErrorInfo::BadRequest => AgereErrorInfo::BadRequest,
            CoreAgereErrorInfo::ThreadRollbackFailed => AgereErrorInfo::ThreadRollbackFailed,
            CoreAgereErrorInfo::AccessError => AgereErrorInfo::AccessError,
            CoreAgereErrorInfo::ResponseStreamDisconnected { http_status_code } => {
                AgereErrorInfo::ResponseStreamDisconnected { http_status_code }
            }
            CoreAgereErrorInfo::ResponseTooManyFailedAttempts { http_status_code } => {
                AgereErrorInfo::ResponseTooManyFailedAttempts { http_status_code }
            }
            CoreAgereErrorInfo::ActiveTurnNotSteerable { turn_kind } => {
                AgereErrorInfo::ActiveTurnNotSteerable {
                    turn_kind: turn_kind.into(),
                }
            }
            CoreAgereErrorInfo::Other => AgereErrorInfo::Other,
        }
    }
}
    ...
    fn from(value: CoreAskForApproval) -> Self {
        match value {
            ...
            CoreAskForApproval::Granular(granular_config) => AskForApproval::Granular {
                access_approval: granular_config.access_approval,
...
/// include permission escalations, blocked network access, MCP approval prompts, and
...
impl JsonSchema for ApprovalsReviewer {
    ...
    fn json_schema(_generator: &mut SchemaGenerator) -> Schema {
        string_enum_schema_with_description(
            ...
            "Configures who approval requests are routed to for review. Examples include permission escalations, blocked network access, MCP approval prompts, and ARC escalations. Defaults to `user`. `auto_review` uses a carefully prompted subagent to gather relevant context and apply a risk-based decision framework before approving or denying the request. The value `guardian_subagent` is accepted as an alias.",
        )
    }
}
...
impl AccessMode {
    pub fn to_core(self) -> CoreAccessMode {
        match self {
            AccessMode::ReadOnly => CoreAccessMode::ReadOnly,
            AccessMode::WorkspaceWrite => CoreAccessMode::WorkspaceWrite,
            AccessMode::DangerFullAccess => CoreAccessMode::DangerFullAccess,
        }
    }
}

impl From<CoreAccessMode> for AccessMode {
    fn from(value: CoreAccessMode) -> Self {
        match value {
            CoreAccessMode::ReadOnly => AccessMode::ReadOnly,
            CoreAccessMode::WorkspaceWrite => AccessMode::WorkspaceWrite,
            CoreAccessMode::DangerFullAccess => AccessMode::DangerFullAccess,
        }
    }
}

v2_enum_from_core!(
    pub enum ReviewDelivery from agere_protocol::protocol::ReviewDelivery {
        Inline, Detached
    }
);

v2_enum_from_core!(
    pub enum McpAuthStatus from agere_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
pub enum ConfigLayerSource {
    ...
    /// User config layer from $AGERE_HOME/config.toml. This layer is special
    ...
    /// Path to a .openagere/ folder within a project. There could be multiple of
    /// these between `cwd` and the project/repo root.
    #[serde(rename_all = "camelCase")]
    #[ts(rename_all = "camelCase")]
    Project {
        dot_agere_folder: AbsolutePathBuf,
    },
...
#[ts(export_to = "v2/")]
pub struct AccessWorkspaceWrite {
    #[serde(default)]
...
pub struct Config {
    ...
    pub access_workspace_write: Option<AccessWorkspaceWrite>,
...
pub struct ConfigRequirements {
    ...
    pub allowed_access_modes: Option<Vec<AccessMode>>,
...
pub struct ExternalAgentConfigDetectParams {
    /// If true, include detection under the user's home (~/.claude, ~/.openagere, etc.).
    #[serde(default, skip_serializing_if = "std::ops::Not::not")]
...
pub struct AdditionalFileSystemPermissions {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
    pub entries: Option<Vec<FileSystemAccessEntry>>,
}
    ...
    fn from(value: CoreFileSystemPermissions) -> Self {
        if let Some((read, write)) = value.legacy_read_write_roots() {
            ...
            if let Some(paths) = read.as_ref() {
                entries.extend(paths.iter().map(|path| FileSystemAccessEntry {
            ...
            Self {
                ...
                entries: Some(
                    value
                        .entries
                        .into_iter()
                        .map(FileSystemAccessEntry::from)
                        .collect(),
                ),
            }
        }
    ...
    fn from(value: AdditionalFileSystemPermissions) -> Self {
        let mut permissions = if let Some(entries) = value.entries {
            Self {
                entries: entries
                    .into_iter()
                    .map(CoreFileSystemAccessEntry::from)
                    .collect(),
                glob_scan_max_depth: None,
            }
        } else {
...
impl From<CoreNetworkAccessPolicy> for PermissionProfileNetworkPermissions {
    fn from(value: CoreNetworkAccessPolicy) -> Self {
        Self {
...
impl From<PermissionProfileNetworkPermissions> for CoreNetworkAccessPolicy {
...
impl From<CoreFileSystemAccessEntry> for FileSystemAccessEntry {
    fn from(value: CoreFileSystemAccessEntry) -> Self {
        Self {
...
impl From<FileSystemAccessEntry> for CoreFileSystemAccessEntry {
    fn from(value: FileSystemAccessEntry) -> Self {
        Self {
            path: value.path.into(),
...
pub enum PermissionProfile {
    /// Agere applies managed filesystem and network restrictions for this profile.
    #[serde(rename_all = "camelCase")]
    #[ts(rename_all = "camelCase")]
    Managed {
    ...
    /// Do not apply an outer access restriction layer.
    Disabled,
...
impl<'de> Deserialize<'de> for AccessPolicy {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        match AccessPolicyDeserialize::deserialize(deserializer)? {
            AccessPolicyDeserialize::DangerFullAccess => Ok(AccessPolicy::DangerFullAccess),
            AccessPolicyDeserialize::ReadOnly {
                network_access,
                access,
            } => {
                ...
                Ok(AccessPolicy::ReadOnly { network_access })
            }
            AccessPolicyDeserialize::External { network_access } => {
                Ok(AccessPolicy::External { network_access })
            }
            AccessPolicyDeserialize::WorkspaceWrite {
                writable_roots,
                read_only_access,
                network_access,
                ...
                Ok(AccessPolicy::WorkspaceWrite {
                    writable_roots,
                    network_access,
                    exclude_tmpdir_env_var,
                    exclude_slash_tmp,
...
impl AccessPolicy {
    pub fn to_permission_profile(&self) -> agere_protocol::models::PermissionProfile {
        ...
        match self {
            AccessPolicy::DangerFullAccess => PermissionProfile::Disabled,
            AccessPolicy::External { network_access } => PermissionProfile::External {
                network: if *network_access == NetworkAccess::Enabled {
                    ...
                    file_system: ManagedFileSystemPermissions::Restricted {
                        entries: vec![FileSystemAccessEntry {
                            path: FileSystemPath::Special {
                                value: agere_protocol::permissions::FileSystemSpecialPath::Root,
                            },
                            access: FileSystemAccessMode::Read,
                        }],
                        glob_scan_max_depth: None,
            ...
            AccessPolicy::WorkspaceWrite {
                ...
                let fs_policy = FileSystemAccessPolicy::workspace_write(
                    writable_roots,
                    *exclude_tmpdir_env_var,
                    *exclude_slash_tmp,
                );
                PermissionProfile::Managed {
                    file_system: ManagedFileSystemPermissions::Restricted {
                        entries: fs_policy.entries,
                        glob_scan_max_depth: fs_policy
                            .glob_scan_max_depth
    ...
    /// Serialize this access policy to the string form used by core configuration.
    pub fn to_core(&self) -> String {
        match self {
            AccessPolicy::DangerFullAccess => "danger-full-access".to_string(),
            AccessPolicy::ReadOnly { .. } => "read-only".to_string(),
            AccessPolicy::External { .. } => "external-access".to_string(),
            AccessPolicy::WorkspaceWrite { .. } => "workspace-write".to_string(),
        }
    }
}
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that Agere-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, Agere attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// Agere attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that Agere was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `agere`).
...
/// Run a standalone command (argv vector) under the server's execution restrictions without
...
pub struct CommandExecParams {
    ...
    /// Optional access policy for this command.
    ///
    /// Uses the same shape as thread/turn permission configuration and
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. Agere Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR AGERE CLOUD - DO NOT USE.
...
impl From<agere_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: agere_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> agere_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => agere_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => agere_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadShellCommandParams {
    ...
    /// such as pipes, redirects, and quoting. This runs with full host access and does not
    /// inherit the thread's permission restrictions.
    pub command: String,
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `agere_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, agere exec, agere app-server, etc.).
...
pub struct TurnError {
    pub message: String,
    pub agere_error_info: Option<AgereErrorInfo>,
    #[serde(default)]
...
pub struct TurnStartParams {
    ...
    #[ts(optional = nullable)]
    pub approvals_reviewer: Option<ApprovalsReviewer>,
    /// Override the access policy for this turn and subsequent turns.
    #[ts(optional = nullable)]
    pub access_policy: Option<AccessPolicy>,
    /// Override the full permissions profile for this turn and subsequent
    /// turns. Cannot be combined with `accessPolicy`.
...
impl From<agere_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: agere_protocol::models::WebSearchAction) -> Self {
        match value {
            ...
            agere_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<agere_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: agere_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> agere_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => agere_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => agere_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => agere_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active Agere turn when this elicitation was observed, if app-server could correlate one.
    ///
...
pub struct PermissionsRequestApprovalResponse {
    ...
    /// Review every subsequent command in this turn before normal execution under the configured restrictions.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
...
impl From<DynamicToolCallOutputContentItem>
    for agere_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
...
mod tests {
    ...
    use agere_protocol::items::ReasoningItem;
    use agere_protocol::items::TurnItem;
    use agere_protocol::items::UserMessageItem;
    use agere_protocol::items::WebSearchItem;
    use agere_protocol::models::PermissionProfile as CorePermissionProfile;
    use agere_protocol::models::WebSearchAction as CoreWebSearchAction;
    use agere_protocol::permissions::NetworkAccessPolicy as CoreNetworkAccessPolicy;
    use agere_protocol::user_input::UserInput as CoreUserInput;
    ...
    fn permission_profile_file_system_permissions_preserves_glob_scan_depth() {
        let core_permissions = CoreManagedFileSystemPermissions::Restricted {
            entries: vec![CoreFileSystemAccessEntry {
                path: CoreFileSystemPath::GlobPattern {
                    pattern: "**/*.env".to_string(),
                },
                access: CoreFileSystemAccessMode::None,
    ...
    fn device_key_sign_params_round_trip_uses_accepted_payload_enum() {
        let params = DeviceKeySignParams {
            ...
            payload: DeviceKeySignPayload::RemoteControlClientConnection {
                ...
                target_path: "/api/agere/remote/control/client".to_string(),
                account_user_id: "account-user-1".to_string(),
                client_id: "cli_123".to_string(),
        ...
        assert_eq!(
            ...
            json!({
                ...
                "payload": {
                    ...
                    "targetPath": "/api/agere/remote/control/client",
                    "accountUserId": "account-user-1",
                    "clientId": "cli_123",
    ...
    #[test]
    fn access_policy_external_enabled_to_core_matches_legacy_permission_profile() {
        let v2_policy = AccessPolicy::External {
            network_access: NetworkAccess::Enabled,
        };

        assert_eq!(v2_policy.to_core(), "external-access");
        assert_eq!(
            v2_policy.to_permission_profile(),
            CorePermissionProfile::External {
                network: CoreNetworkAccessPolicy::Enabled,
            },
        );
        assert_eq!(
            CorePermissionProfile::from_legacy_access_policy(v2_policy.to_core().as_str()),
            v2_policy.to_permission_profile(),
        );
    }

    #[test]
    fn access_policy_external_restricted_legacy_string_maps_to_external_enabled() {
        let v2_policy = AccessPolicy::External {
        ...
        assert_eq!(
            v2_policy.to_permission_profile(),
            CorePermissionProfile::External {
                network: CoreNetworkAccessPolicy::Restricted,
            },
        );
        assert_eq!(
            CorePermissionProfile::from_legacy_access_policy(v2_policy.to_core().as_str()),
    ...
    #[test]
    fn access_policy_read_only_network_access_reflects_legacy_string_and_profile() {
        let v2_policy = AccessPolicy::ReadOnly {
            network_access: true,
        };

        assert_eq!(v2_policy.to_core(), "read-only");
        assert_eq!(
            v2_policy.to_permission_profile().network_access_policy(),
            CoreNetworkAccessPolicy::Enabled,
        );
        assert_eq!(
            CorePermissionProfile::from_legacy_access_policy(v2_policy.to_core().as_str())
                .network_access_policy(),
            CoreNetworkAccessPolicy::Restricted,
        );
    }
    ...
    #[test]
    fn access_policy_workspace_write_to_core_and_managed_profile() {
        let v2_policy = AccessPolicy::WorkspaceWrite {
            writable_roots: vec![],
            network_access: true,
        ...
        assert_eq!(v2_policy.to_core(), "workspace-write");
        assert_eq!(
            v2_policy.to_permission_profile().network_access_policy(),
            CoreNetworkAccessPolicy::Enabled,
        );
    ...
    #[test]
    fn access_policy_deserializes_legacy_read_only_full_access_field() {
        let policy = serde_json::from_value::<AccessPolicy>(json!({
            "type": "readOnly",
            "access": {
                "type": "fullAccess"
            },
    ...
    #[test]
    fn access_policy_deserializes_legacy_workspace_write_full_access_field() {
    ...
    #[test]
    fn access_policy_rejects_legacy_read_only_restricted_access_field() {
        let err = serde_json::from_value::<AccessPolicy>(json!({
            "type": "readOnly",
            "access": {
                "type": "restricted",
    ...
    #[test]
    fn access_policy_rejects_legacy_workspace_write_restricted_read_access_field() {
        let err = serde_json::from_value::<AccessPolicy>(json!({
            "type": "workspaceWrite",
            "writableRoots": [],
            "readOnlyAccess": {
        ...
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput::Skill {
                    ...
                    path: PathBuf::from("/repo/.openagere/skills/skill-creator/SKILL.md"),
                },
    ...
    fn plugin_source_serializes_local_git_and_remote_variants() {
        ...
        assert_eq!(
            serde_json::to_value(PluginSource::Git {
                url: "https://github.com/openagere/example.git".to_string(),
            ...
            json!({
                "type": "git",
                "url": "https://github.com/openagere/example.git",
    ...
    fn plugin_marketplace_entry_serializes_remote_only_path_as_null() {
        assert_eq!(
            serde_json::to_value(PluginMarketplaceEntry {
                name: "openagere-curated".to_string(),
                path: None,
                interface: None,
                plugins: Vec::new(),
            })
    ...
    fn plugin_read_params_serialization_uses_install_source_fields() {
        ...
        assert_eq!(
            serde_json::from_value::<PluginReadParams>(json!({
                "remoteMarketplaceName": "openagere-curated",
                "pluginName": "gmail",
            }))
            .unwrap(),
            PluginReadParams {
                marketplace_path: None,
                remote_marketplace_name: Some("openagere-curated".to_string()),
                plugin_name: "gmail".to_string(),
            },
        );
    }
    ...
    fn plugin_uninstall_params_serialization_omits_force_remote_sync() {
        assert_eq!(
            serde_json::to_value(PluginUninstallParams {
                plugin_id: "gmail@openagere-curated".to_string(),
            })
            .unwrap(),
            json!({
                "pluginId": "gmail@openagere-curated",
            }),
        );
    ...
    #[test]
    fn agere_error_info_serializes_http_status_code_in_camel_case() {
        let value = AgereErrorInfo::ResponseTooManyFailedAttempts {
    ...
    #[test]
    fn agere_error_info_serializes_cyber_policy_in_camel_case() {
        assert_eq!(
            serde_json::to_value(AgereErrorInfo::CyberPolicy).unwrap(),
            json!("cyberPolicy")
        );
    }

    #[test]
    fn agere_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
        let value = AgereErrorInfo::ActiveTurnNotSteerable {
    ...
    fn thread_lifecycle_responses_default_missing_compat_fields() {
        let response = json!({
            ...
            "approvalsReviewer": "user",
            "accessPolicy": { "type": "dangerFullAccess" },
    ...
    #[test]
    fn turn_start_params_accept_model_provider_override() {
        let params: TurnStartParams = serde_json::from_value(json!({
            "threadId": "thread_123",
            "input": [],
            "modelProvider": "next-provider"
        ...
        assert_eq!(params.model_provider.as_deref(), Some("next-provider"));
    }
