use agere_core_skills::AvailableSkills;
use agere_core_skills::render_available_skills_body;
use agere_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use agere_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
