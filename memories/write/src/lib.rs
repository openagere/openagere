//! Write-path implementation for Agere memories.
//!
...
mod guard_limits {
    #[allow(dead_code)]
    pub(super) const AGERE_LIMIT_ID: &str = "agere";
}
...
mod stage_one {
    ...
    pub(super) const REASONING_EFFORT: agere_protocol::openai_models::ReasoningEffort =
        agere_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    ...
    pub(super) const REASONING_EFFORT: agere_protocol::openai_models::ReasoningEffort =
        agere_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
