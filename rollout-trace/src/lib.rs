//! Trace bundle format, writer, and reducer for Agere rollouts.
//!
//! This crate owns the trace schema. Hot-path Agere code should depend on the
...
/// Shared recorder context for inference attempts within one Agere turn.
...
pub use thread::AGERE_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Agere tool boundary.
...
/// Append-only writer used by hot-path Agere instrumentation.
