...
use agere_analytics::GuardianReviewedAction;
use agere_protocol::approvals::GuardianAssessmentAction;
use agere_protocol::approvals::GuardianCommandSource;
...
pub(crate) enum GuardianApprovalRequest {
    Shell {
        ...
        command: Vec<String>,
        cwd: AbsolutePathBuf,
        permission_level: crate::execution::ExecutionPermissionLevel,
...
pub(crate) struct GuardianNetworkAccessTrigger {
    ...
    pub(crate) permission_level: crate::execution::ExecutionPermissionLevel,
...
fn command_assessment_action(
    ...
    GuardianAssessmentAction::Command {
        source,
        command: agere_shell_command::parse_command::shlex_join(command),
        cwd: cwd.clone(),
    }
}
