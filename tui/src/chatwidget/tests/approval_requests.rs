...
fn app_server_exec_approval_request_preserves_permissions_context() {
    ...
    let request = exec_approval_request_from_params(
        AppServerCommandExecutionRequestApprovalParams {
            ...
            approval_id: Some("approval-1".to_string()),
            reason: None,
            network_approval_context: Some(agere_app_server_protocol::NetworkApprovalContext {
    ...
    assert_eq!(
        ...
        Some(agere_protocol::protocol::NetworkApprovalContext {
            host: "example.com".to_string(),
            protocol: agere_protocol::protocol::NetworkApprovalProtocol::Socks5Tcp,
        })
    );
    assert_eq!(
        request.additional_permissions,
        Some(agere_protocol::models::AdditionalPermissionProfile {
