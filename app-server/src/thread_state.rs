...
type PendingInterruptQueue = Vec<(
    ConnectionRequestId,
    crate::agere_message_processor::ApiVersion,
)>;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: agere_app_server_protocol::Thread,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<AgereThread>>,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<AgereThread>) -> bool {
