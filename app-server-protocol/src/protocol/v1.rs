...
pub use agere_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $AGERE_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [agere_protocol::protocol::PatchApplyBeginEvent]
    /// and [agere_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [agere_protocol::protocol::ExecCommandBeginEvent]
    /// and [agere_protocol::protocol::ExecCommandEndEvent].
    pub call_id: String,
...
pub struct GetAuthStatusResponse {
    ...
    pub requires_provider_auth: Option<bool>,
}
