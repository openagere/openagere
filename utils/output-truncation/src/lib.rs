//! Helpers for truncating tool and exec output using [`TruncationPolicy`](agere_protocol::protocol::TruncationPolicy).

use agere_protocol::models::FunctionCallOutputContentItem;
pub use agere_utils_common::approx_bytes_for_tokens;
pub use agere_utils_common::approx_token_count;
pub use agere_utils_common::approx_tokens_from_byte_count;
use agere_utils_common::truncate_middle_chars;
use agere_utils_common::truncate_middle_with_token_budget;

pub use agere_protocol::protocol::TruncationPolicy;
