...
fn resume_history(
    config: &agere_core::config::Config,
    previous_model: &str,
...
async fn emits_warning_when_resumed_model_differs() {
    ...
    let thread_manager = agere_core::test_support::thread_manager_with_models_provider(
        AgereAuth::from_api_key("test"),
        config.model_provider.clone(),
    );
    let auth_manager =
        agere_core::test_support::auth_manager_from_auth(AgereAuth::from_api_key("test"));
