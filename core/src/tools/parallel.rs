...
impl ToolCallRuntime {
    ...
    pub(crate) fn find_spec(&self, tool_name: &agere_tools::ToolName) -> Option<ToolSpec> {
    ...
    pub(crate) fn handle_tool_call(
    ...
    ) -> impl std::future::Future<Output = Result<ResponseInputItem, AgereErr>> {
        ...
        async move {
            match future.await {
                ...
                Err(FunctionCallError::Fatal(message)) => Err(AgereErr::Fatal(message)),
        ...
        match call.payload {
            ...
            ToolPayload::Custom { .. } => ResponseInputItem::CustomToolCallOutput {
                ...
                output: agere_protocol::models::FunctionCallOutputPayload {
                    body: agere_protocol::models::FunctionCallOutputBody::Text(message),
                    success: Some(false),
                },
            },
