...
use agere_tools::ToolHandlerKind;
use agere_tools::ToolName;
use agere_tools::ToolNamespace;
use agere_tools::ToolRegistryPlanDeferredTool;
use agere_tools::ToolRegistryPlanMcpTool;
use agere_tools::ToolRegistryPlanParams;
use agere_tools::ToolUserShellType;
use agere_tools::ToolsConfig;
use agere_tools::WaitAgentTimeoutOptions;
use agere_tools::augment_tool_spec_for_code_mode;
use agere_tools::build_tool_registry_plan;
...
pub(crate) fn build_specs_with_discoverable_tools(
    ...
    for unavailable_tool in unavailable_called_tools {
        ...
        if existing_spec_names.insert(tool_name.clone()) {
            let spec = agere_tools::ToolSpec::Function(ResponsesApiTool {
