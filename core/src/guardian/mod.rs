...
const GUARDIAN_PREFERRED_MODEL: &str = "agere-auto-review";
...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: agere_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: agere_protocol::protocol::GuardianUserAuthorization,
