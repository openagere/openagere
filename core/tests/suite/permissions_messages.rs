...
use agere_core::context::ContextualUserFragment;
use agere_core::context::PermissionsInstructions;
use agere_core::load_exec_policy;
...
async fn permissions_message_includes_writable_roots() -> Result<()> {
    ...
    let access_policy = test.config.legacy_access_policy();
