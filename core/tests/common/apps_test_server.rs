...
const SERVER_NAME: &str = "agere-apps-test";
...
async fn mount_streamable_http_json_rpc(
    ...
    Mock::given(method("POST"))
        .and(path_regex("^/api/agere/apps/?$"))
        .respond_with(AgereAppsJsonRpcResponder {
            connector_name,
...
struct AgereAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
}

impl Respond for AgereAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let agere_apps_meta = body.pointer("/params/_meta/_agere_apps").cloned();
