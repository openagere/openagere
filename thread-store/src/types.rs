...
use agere_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    /// Thread id generated by Agere before opening persistence.
...
pub struct StoredThread {
    ...
    /// Legacy access-policy label captured for the thread (permission profile snapshot).
