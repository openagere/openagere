...
async fn list_and_get_render_expected_output() -> Result<()> {
    ...
    let mut add = agere_command(agere_home.path())?;
    add.args([
        "mcp",
        "add",
        "docs",
    ...
    let mut servers = load_global_mcp_servers(agere_home.path()).await?;
    ...
    let mut list_cmd = agere_command(agere_home.path())?;
    ...
    let mut list_json_cmd = agere_command(agere_home.path())?;
    ...
    let mut get_cmd = agere_command(agere_home.path())?;
    ...
    assert!(stdout.contains("remove: agere mcp remove docs"));

    let mut get_json_cmd = agere_command(agere_home.path())?;
    get_json_cmd
