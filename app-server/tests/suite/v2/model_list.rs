...
use agere_app_server_protocol::Model;
use agere_app_server_protocol::ModelListParams;
use agere_app_server_protocol::ModelListResponse;
use agere_app_server_protocol::ModelUpgradeInfo;
use agere_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        agere_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
