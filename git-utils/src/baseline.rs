...
const BASELINE_COMMIT_MESSAGE: &str =
    "Initialize Agere git baseline\n\nCo-authored-by: Agere <noreply@openagere.com>";
...
fn agere_signature() -> gix::actor::Signature {
    gix::actor::Signature {
        name: "Agere".into(),
        email: "noreply@openagere.com".into(),
        time: gix::date::Time {
