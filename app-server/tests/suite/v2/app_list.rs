...
use agere_app_server_protocol::AppBranding;
use agere_app_server_protocol::AppInfo;
use agere_app_server_protocol::AppListUpdatedNotification;
use agere_app_server_protocol::AppMetadata;
use agere_app_server_protocol::AppReview;
...
#[tokio::test]
#[ignore]
async fn list_apps_returns_empty_when_workspace_agere_plugins_disabled() -> Result<()> {
    let connectors = vec![AppInfo {
        id: "beta".to_string(),
        name: "Beta".to_string(),
        description: Some("Beta connector".to_string()),
