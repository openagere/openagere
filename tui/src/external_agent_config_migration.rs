...
mod tests {
    ...
    fn sample_plugin_details() -> agere_app_server_protocol::MigrationDetails {
        agere_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.openagere/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
