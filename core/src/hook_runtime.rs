...
use agere_analytics::HookRunFact;
use agere_analytics::build_track_events_context;
use agere_hooks::PermissionRequestDecision;
use agere_hooks::PermissionRequestOutcome;
use agere_hooks::PermissionRequestRequest;
use agere_hooks::PostToolUseOutcome;
use agere_hooks::PostToolUseRequest;
use agere_hooks::PreToolUseOutcome;
use agere_hooks::PreToolUseRequest;
use agere_hooks::SessionStartOutcome;
use agere_hooks::UserPromptSubmitOutcome;
use agere_hooks::UserPromptSubmitRequest;
use agere_otel::HOOK_RUN_DURATION_METRIC;
use agere_otel::HOOK_RUN_METRIC;
...
use agere_protocol::protocol::HookCompletedEvent;
use agere_protocol::protocol::HookEventName;
use agere_protocol::protocol::HookRunStatus;
use agere_protocol::protocol::HookRunSummary;
use agere_protocol::protocol::HookSource;
use agere_protocol::protocol::HookStartedEvent;
...
pub(crate) async fn run_pending_session_start_hooks(
    ...
    let request = agere_hooks::SessionStartRequest {
...
fn hook_run_analytics_payload(
    ...
    completed: &HookCompletedEvent,
) -> (agere_analytics::TrackEventsContext, HookRunFact) {
    (
...
mod tests {
    ...
    use agere_protocol::protocol::HookEventName;
    use agere_protocol::protocol::HookExecutionMode;
    use agere_protocol::protocol::HookHandlerType;
    use agere_protocol::protocol::HookRunStatus;
    use agere_protocol::protocol::HookScope;
    use agere_protocol::protocol::HookSource;
