...
use agere_protocol::models::ShellCommandToolCallParams;
...
fn shell_payload_command(payload: &ToolPayload) -> Option<String> {
    match payload {
        ToolPayload::Function { arguments } => parse_arguments::<ShellToolCallParams>(arguments)
            .ok()
            .map(|params| agere_shell_command::parse_command::shlex_join(&params.command)),
        ToolPayload::LocalShell { params } => Some(agere_shell_command::parse_command::shlex_join(
            &params.command,
        )),
        _ => None,
    }
        ...
        match payload {
            ToolPayload::Function { arguments } => {
                ...
                Self::run_exec_like(RunExecLikeArgs {
                    ...
                    exec_params,
                    hook_command: agere_shell_command::parse_command::shlex_join(&params.command),
...
impl ShellHandler {
    async fn run_exec_like(args: RunExecLikeArgs) -> Result<FunctionToolOutput, FunctionCallError> {
        ...
        .map_or_else(
            || {
                normalize_and_validate_additional_permissions(
                    ...
                    effective_additional_permissions.permission_level,
        ...
        if effective_additional_permissions
            .permission_level
            .requests_escalated_permissions()
            && !effective_additional_permissions.permissions_preapproved
            && !matches!(
                turn.approval_policy.value(),
                agere_protocol::protocol::AskForApproval::OnRequest
            )
        {
        ...
        let file_system_access_policy = turn.file_system_access_policy();
        let exec_approval_requirement = session
            ...
            .create_exec_approval_requirement_for_command(ExecApprovalRequest {
                ...
                access_cwd: turn.cwd.as_path(),
                permission_level: if effective_additional_permissions.permissions_preapproved {
        ...
        let req = ShellRequest {
            ...
            permission_level: effective_additional_permissions.permission_level,
        ...
        Ok(FunctionToolOutput {
            body: vec![
                agere_protocol::models::FunctionCallOutputContentItem::InputText { text: content },
            ],
            success: Some(true),
