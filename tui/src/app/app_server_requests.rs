...
use agere_protocol::mcp::RequestId as McpRequestId;
                    ...
                    Ok::<AppServerRequestResolution, String>(AppServerRequestResolution {
                        ...
                        result: serde_json::to_value(McpServerElicitationRequestResponse {
                            action: match decision {
                                agere_protocol::approvals::ElicitationAction::Accept => {
                                    McpServerElicitationAction::Accept
                                }
                                agere_protocol::approvals::ElicitationAction::Decline => {
                                    McpServerElicitationAction::Decline
                                }
                                agere_protocol::approvals::ElicitationAction::Cancel => {
...
mod tests {
    ...
    use agere_app_server_protocol::PermissionGrantScope;
    use agere_app_server_protocol::PermissionsRequestApprovalParams;
    use agere_app_server_protocol::PermissionsRequestApprovalResponse;
    use agere_app_server_protocol::RequestId as AppServerRequestId;
    use agere_app_server_protocol::ServerRequest;
    use agere_app_server_protocol::ToolRequestUserInputAnswer;
    use agere_app_server_protocol::ToolRequestUserInputParams;
    use agere_app_server_protocol::ToolRequestUserInputResponse;
    use agere_protocol::approvals::ElicitationAction;
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: agere_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: agere_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: agere_app_server_protocol::GrantedPermissionProfile {
        ...
        let user_input = pending
            .take_resolution(&Op::UserInputAnswer {
                id: "turn-2".to_string(),
                response: agere_protocol::request_user_input::RequestUserInputResponse {
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: agere_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: agere_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: agere_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
    ...
    fn same_turn_user_input_answers_resolve_app_server_requests_fifo() {
        ...
        let response = agere_protocol::request_user_input::RequestUserInputResponse {
            answers: HashMap::new(),
        };
