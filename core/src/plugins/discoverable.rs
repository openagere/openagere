...
use agere_core_plugins::OPENAGERE_BUNDLED_MARKETPLACE_NAME;
...
const TOOL_SUGGEST_DISCOVERABLE_PLUGIN_ALLOWLIST: &[&str] = &[
    "github@openagere-curated",
    "notion@openagere-curated",
    "slack@openagere-curated",
    "gmail@openagere-curated",
    "google-calendar@openagere-curated",
    "google-drive@openagere-curated",
    "linear@openagere-curated",
    "figma@openagere-curated",
    "computer-use@openagere-bundled",
];

const TOOL_SUGGEST_DISCOVERABLE_MARKETPLACE_ALLOWLIST: &[&str] = &[
    OPENAGERE_BUNDLED_MARKETPLACE_NAME,
    OPENAGERE_CURATED_MARKETPLACE_NAME,
];
...
pub(crate) async fn list_tool_suggest_discoverable_plugins(
    ...
    let plugins_manager = PluginsManager::new(config.agere_home.to_path_buf());
