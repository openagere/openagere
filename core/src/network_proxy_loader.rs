use crate::config::find_agere_home;
...
use agere_config::permissions_toml::overlay_network_domain_permissions;
...
use agere_network_proxy::NetworkProxyConstraintError;
...
fn upsert_network_domain(
    config: &mut NetworkProxyConfig,
    host: String,
    permission: agere_network_proxy::NetworkDomainPermission,
) {
    config
        .network
