...
use agere_rmcp_client::OAuthProviderError;
use agere_rmcp_client::determine_streamable_http_auth_status;
use agere_rmcp_client::discover_streamable_http_oauth;
use anyhow::Result;
use futures::future::join_all;
use tracing::warn;

use super::AGERE_APPS_MCP_SERVER_NAME;
    ...
    I: IntoIterator<Item = (&'a String, &'a McpServerConfig)>,
{
    let futures = servers.into_iter().map(|(name, config)| {
        ...
        let has_runtime_auth = name == AGERE_APPS_MCP_SERVER_NAME
