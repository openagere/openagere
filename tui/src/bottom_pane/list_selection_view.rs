...
mod tests {
    ...
    fn make_selection_view(subtitle: Option<&str>) -> ListSelectionView {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some("Agere can read files".to_string()),
                is_current: true,
            ...
            SelectionItem {
                ...
                description: Some("Agere can edit files".to_string()),
                is_current: false,
                dismiss_on_select: true,
                ..Default::default()
            },
    ...
    #[test]
    fn popup_surface_has_background_without_border_glyphs() {
        let view = make_selection_view(Some("Choose a preset"));
        let area = Rect::new(0, 0, 48, view.desired_height(48));
        let mut buf = Buffer::empty(area);
    ...
    fn renders_blank_line_between_subtitle_and_items() {
        let view = make_selection_view(Some("Switch between Agere approval presets"));
    ...
    fn snapshot_footer_note_wraps() {
        ...
        let footer_note = Line::from(vec![
            "Note: ".dim(),
            "Use /setup-default-restriction".cyan(),
    ...
    fn width_changes_do_not_hide_rows() {
        ...
        let items = vec![
            ...
            SelectionItem {
                ...
                description: Some(
                    "Smaller model for faster, lower-cost everyday coding tasks.".to_string(),
                ),
                dismiss_on_select: true,
                ..Default::default()
            },
            SelectionItem {
                ...
                description: Some(
                    "Alternative provider model for coding and agentic workflows.".to_string(),
                ),
                dismiss_on_select: true,
                ..Default::default()
            },
