...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: Agere is rebuilding normal terminal scrollback, not an
...
use agere_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
