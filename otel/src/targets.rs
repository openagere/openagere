pub(crate) const OTEL_TARGET_PREFIX: &str = "agere_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "agere_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "agere_otel.trace_safe";
