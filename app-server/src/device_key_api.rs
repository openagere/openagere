...
use agere_app_server_protocol::DeviceKeyAlgorithm;
use agere_app_server_protocol::DeviceKeyCreateParams;
use agere_app_server_protocol::DeviceKeyCreateResponse;
use agere_app_server_protocol::DeviceKeyProtectionClass;
use agere_app_server_protocol::DeviceKeyPublicParams;
use agere_app_server_protocol::DeviceKeyPublicResponse;
use agere_app_server_protocol::DeviceKeySignParams;
use agere_app_server_protocol::DeviceKeySignPayload;
use agere_app_server_protocol::DeviceKeySignResponse;
use agere_app_server_protocol::JSONRPCErrorError;
use agere_device_key::DeviceKeyBinding;
use agere_device_key::DeviceKeyBindingStore;
use agere_device_key::DeviceKeyCreateRequest;
use agere_device_key::DeviceKeyError;
use agere_device_key::DeviceKeyGetPublicRequest;
use agere_device_key::DeviceKeyInfo;
use agere_device_key::DeviceKeyProtectionPolicy;
use agere_device_key::DeviceKeySignRequest;
use agere_device_key::DeviceKeyStore;
use agere_device_key::RemoteControlClientConnectionAudience;
use agere_device_key::RemoteControlClientConnectionSignPayload;
use agere_device_key::RemoteControlClientEnrollmentAudience;
use agere_device_key::RemoteControlClientEnrollmentSignPayload;
use agere_state::DeviceKeyBindingRecord;
...
fn protection_policy_from_params(
    protection_policy: Option<agere_app_server_protocol::DeviceKeyProtectionPolicy>,
) -> DeviceKeyProtectionPolicy {
    match protection_policy
        .unwrap_or(agere_app_server_protocol::DeviceKeyProtectionPolicy::HardwareOnly)
    {
        agere_app_server_protocol::DeviceKeyProtectionPolicy::HardwareOnly => {
            DeviceKeyProtectionPolicy::HardwareOnly
        }
        agere_app_server_protocol::DeviceKeyProtectionPolicy::AllowOsProtectedNonextractable => {
            DeviceKeyProtectionPolicy::AllowOsProtectedNonextractable
        }
    }
}

fn payload_from_params(payload: DeviceKeySignPayload) -> agere_device_key::DeviceKeySignPayload {
    match payload {
        DeviceKeySignPayload::RemoteControlClientConnection {
            ...
            token_expires_at,
            scopes,
        } => agere_device_key::DeviceKeySignPayload::RemoteControlClientConnection(
        ...
        } => agere_device_key::DeviceKeySignPayload::RemoteControlClientEnrollment(
...
fn remote_control_client_connection_audience_from_protocol(
    audience: agere_app_server_protocol::RemoteControlClientConnectionAudience,
) -> RemoteControlClientConnectionAudience {
    match audience {
        agere_app_server_protocol::RemoteControlClientConnectionAudience::RemoteControlClientWebsocket => {
...
fn remote_control_client_enrollment_audience_from_protocol(
    audience: agere_app_server_protocol::RemoteControlClientEnrollmentAudience,
) -> RemoteControlClientEnrollmentAudience {
    match audience {
        agere_app_server_protocol::RemoteControlClientEnrollmentAudience::RemoteControlClientEnrollment => {
            RemoteControlClientEnrollmentAudience::RemoteControlClientEnrollment
        }
    }
}

fn algorithm_from_store(algorithm: agere_device_key::DeviceKeyAlgorithm) -> DeviceKeyAlgorithm {
    match algorithm {
        agere_device_key::DeviceKeyAlgorithm::EcdsaP256Sha256 => {
...
fn protection_class_from_store(
    protection_class: agere_device_key::DeviceKeyProtectionClass,
) -> DeviceKeyProtectionClass {
    match protection_class {
        agere_device_key::DeviceKeyProtectionClass::HardwareSecureEnclave => {
            DeviceKeyProtectionClass::HardwareSecureEnclave
        }
        agere_device_key::DeviceKeyProtectionClass::HardwareTpm => {
            DeviceKeyProtectionClass::HardwareTpm
        }
        agere_device_key::DeviceKeyProtectionClass::OsProtectedNonextractable => {
