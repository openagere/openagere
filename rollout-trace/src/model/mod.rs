...
/// Agere conversation/session UUID.
...
/// Process/session ID returned by Agere's terminal runtime.
...
/// Canonical reduced graph for one Agere rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the Agere rollout/session being observed. `trace_id`
    ...
    pub agere_turns: BTreeMap<AgereTurnId, AgereTurn>,
