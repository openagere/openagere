...
async fn submit_turn(
    ...
    let permission_profile = turn_permission_fields(permission_profile, test.config.cwd.as_path());
    test.agere
        .submit(Op::UserTurn {
            environments: None,
...
#[cfg(target_os = "macos")]
async fn approved_folder_write_request_permissions_unblocks_later_exec_without_extra_wrappers()
-> Result<()> {
